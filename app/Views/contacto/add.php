        ...
        <div class="row">
            <div class="col-md-6">
                <div class="text-center">
                    ...
                    <img src="<?= base_url('imagenes/dulcepan.png'); ?>" alt="Imagen de contacto" class="img-fluid" style="max-width: 100%; height: auto;">
                </div>
            </div>

            <div class="col-md-6">
                <!-- Formulario de Contacto -->
                <form method="POST" action="<?= site_url('contacto/insert') ?>">
                    <div class="card" style="background-color: #003366; color: white;">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="telefono" type="text" class="form-control" id="telefono" required placeholder="Teléfono">
                            </div>

                            <div class="form-group">
                                <label for="mensaje">Mensaje</label>
                                <textarea name="mensaje" class="form-control" id="mensaje" required placeholder="Escriba su mensaje"></textarea>
                            </div>
